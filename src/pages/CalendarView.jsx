        ...
        return (
          <div className="flex flex-col gap-1 mt-1">
            ...
            {dayTransactions.length > 2 && (
              <div className="text-[10px] text-slate-500">+{dayTransactions.length - 2} more</div>
            )}
          </div>
        );
      }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-slate-800">
          ...
          <div className="text-sm text-slate-500 mb-4">{upcomingPayments.length} Scheduled</div>
          ...
          <div className="space-y-4">
            {upcomingPayments.map(payment => (
              ...
              >
                ...
                <div className={`font-bold ${payment.type === 'Income' ? 'text-emerald-500' : 'text-rose-500'}`}>
