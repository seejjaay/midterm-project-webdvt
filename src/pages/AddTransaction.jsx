  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <form
        ...
        className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-slate-800 space-y-6"
      >
        {/* Name */}
        <div>
        ...
        <div>
          ...
          <div className="flex gap-4">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              <span
                className={
                  formData.type === "Expense" ? "text-rose-500 font-medium" : ""
                }
              >
                Expense
              </span>
        ...
        <div>
          ...
          />
          {errors.date && (
            <p className="text-rose-500 text-sm mt-1">{errors.date}</p>
          )}
        </div>
