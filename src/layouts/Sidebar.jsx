...
import { LayoutDashboard, Wallet, PlusCircle, Calendar as CalendarIcon, PieChart } from 'lucide-react';
...
export function Sidebar() {
  return (
    <aside className="w-64 bg-slate-100 dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 hidden md:flex flex-col h-full sticky top-0 left-0">
      <div className="p-6">
        <h1 className="text-2xl font-bold text-slate-800 dark:text-white tracking-tight">Walletter</h1>
      </div>
            ...
            className={({ isActive }) =>
              twMerge(
                clsx(
                  ...
                  isActive && 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400'
                )
              )
            }
          >
          ...
          className={({ isActive }) =>
            twMerge(
              clsx(
                ...
                isActive && 'text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/20'
              )
            )
          }
        >
